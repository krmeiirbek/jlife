...
class _CleaningPageState extends State<CleaningPage> {
  // Rooms to clean
  List<dynamic> _rooms =[
    ['Қонақ бөлме', 'assets/icons/living-room.png', Colors.red, 0],
    ['Жатын бөлме',     'assets/icons/bedroom.png', Colors.orange, 1],
    ['Жуынатын бөлме',    'assets/icons/bath.png', Colors.blue, 1],
    ['Ас бөлме',     'assets/icons/kitchen.png', Colors.purple, 0],
    ['Кеңсе',      'assets/icons/office.png', Colors.green, 0]
  ];
            ...
            Container(
              child: Column(
                ...
                children: [
                  ...
                  Text("${room[0]} саны?", style: TextStyle(fontSize: 15),),
